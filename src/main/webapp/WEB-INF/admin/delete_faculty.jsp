...
<head>
    ...
    <title><fmt:message key="title.delete.faculty"/></title>
</head>
<body>
<%@include file="/WEB-INF/jspf/admin/navbar.jspf" %>
<br>
<h3><fmt:message key="title.delete.faculty"/></h3><br>
        ...
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <c:choose>
                <c:when test="${not empty pageContext.request.getAttribute(\"faculties\")}">
                    <form method="post" action="${pageContext.request.contextPath}/delete_faculty">
                        <div class="form-row">
                        ...
                        <div style="text-align: center;">
                            <button type="submit" class="btn btn-outline-primary"><fmt:message
                                    key="form.manage.university.button.delete"/></button>
                        </div>
                    </form>
                </c:when>
                <c:otherwise>
