...
<head>
    ...
    <title><fmt:message key="title.unblocking"/></title>
</head>
<body>
<%@include file="/WEB-INF/jspf/admin/navbar.jspf" %>
<br>
<h3><fmt:message key="title.unblocking.h"/></h3><br>
...
<div class="col-md-4">
    <div class="tab-content profile-tab" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <form method="post" action="${pageContext.request.contextPath}/admin/unblock_user">
                <div class="form-row">
                ...
                <div style="text-align: left;">
                    <button type="submit" class="btn btn-outline-primary"><fmt:message
                            key="form.unblock.user.button"/></button>
                </div>
            </form>
        </div>
    </div>
